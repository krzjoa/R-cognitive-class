...
My main goal is to benchmark both appraoches and check, which one has smaller overhead. The computer they were tested on is

```{r sys}
sessionInfo()
```

I tested it ob my good old notebook, which is no a beast.
