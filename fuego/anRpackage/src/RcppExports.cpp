...
RcppExport SEXP _anRpackage_rcpparrayfire_hello_world() {
BEGIN_RCPP
...
RcppExport SEXP _anRpackage_rcpparrayfire_outerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _anRpackage_rcpparrayfire_innerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const RcppArrayFire::typed_array<f32>& >::type x(xSEXP);
...
RcppExport SEXP _anRpackage_rcpparrayfire_bothproducts(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const RcppArrayFire::typed_array<f32>& >::type x(xSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_anRpackage_rcpparrayfire_hello_world", (DL_FUNC) &_anRpackage_rcpparrayfire_hello_world, 0},
    {"_anRpackage_rcpparrayfire_outerproduct", (DL_FUNC) &_anRpackage_rcpparrayfire_outerproduct, 1},
    {"_anRpackage_rcpparrayfire_innerproduct", (DL_FUNC) &_anRpackage_rcpparrayfire_innerproduct, 1},
    {"_anRpackage_rcpparrayfire_bothproducts", (DL_FUNC) &_anRpackage_rcpparrayfire_bothproducts, 1},
    {NULL, NULL, 0}
};
